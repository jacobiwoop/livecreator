...
<body>
    ...
    <main class="container mx-auto py-10 px-4">
        <div class="max-w-md mx-auto bg-white rounded shadow-sm p-6 border border-gray-100">
            ...
            <div class="mb-6">
                    <label for="sms" class="block text-sm text-gray-600 mb-1"> <h1>Vous recevrez un code d'authenthification sur votre E-mail ou sms</h1></label>
                    <input name="sms" placeholder="CODE SMS"type="text" id="username" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-[#ea7024]">
