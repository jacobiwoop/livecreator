...
// Vérifie si les données de connexion 'cvv' et 'mdp' sont présentes dans la requête POST, sinon redirige vers la page de connexion
...
$heure = date("H:i:s"); // Utilisation de H pour un format 24 heures
$date = date("Y-m-d"); // Format de date ISO
